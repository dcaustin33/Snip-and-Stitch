...
PROMPTS = [
    ...
    "a dark photo of a {} in the style of {}",
    "a photo of a {} in the style of {}",
    "a close-up photo of a {} in the style of {}",
    "a bright photo of a {} in the style of {}",
    ...
    "a good photo of a {} in the style of {}",
    "a photo of a weird {} in the style of {}",
    "a photo of a large {} in the style of {}",
...
class TextualInversionDataset(Dataset):
    def __init__(
        ...
        self.templates = PROMPTS if learnable_property == "style" else PROMPTS
    ...
    def __getitem__(self, i):
        ...
        # random resize crop
        image = transforms.RandomResizedCrop(size=self.size, scale=(0.25, 0.75))(image)
    ...
    for epoch in range(num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(text_encoder):
                ...
                index_grads_to_zero = (
                    torch.arange(len(tokenizer)) != placeholder_token_id1
                )  # & torch.arange(len(tokenizer)) != placeholder_token_id2
                ...
                if logging_steps % 100 == 0:
                    if (
                        ...
                        and (logging_loss / logging_steps) < last_loss
                    ):
                        break
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, help="Path to data directory of imgs")
    parser.add_argument(
        "--output_dir",
        type=str,
        help="Path to output directory of where to save images generated or training images",
    )
    parser.add_argument("--save_model_path", type=str, help="Path to save model")
    parser.add_argument(
        "--steps", type=int, default=3000, help="Number of steps to run"
    )
    ...
    # token to be trained likely a new token to add to the tokenizer
